...
export function TrackContextMenu({ track, x, y, onClose, onEditMetadata }: TrackContextMenuProps) {
  ...
  // Grace period so the submenu survives the pointer crossing the ml-1 gap
  // (margins don't hit-test) or dipping over a sibling row en route.
  const openPlaylistSub = () => {
  ...
  const scheduleClosePlaylistSub = () => {
  ...
  return (
    <div ref={menuRef} style={style} className="bg-cosmic-surface border border-cosmic-border/60 rounded-lg shadow-xl shadow-black/50 py-1 min-w-[200px] backdrop-blur-xl">
      ...
      <div
        ...
        onMouseEnter={openPlaylistSub}
        onMouseLeave={scheduleClosePlaylistSub}
      >
